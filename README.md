...
![calculadora-logica-banner-rep](https://github.com/p1nheiros/calculadora-logica/assets/124714182/30281619-245b-4558-9296-9d7d060fc323)
...
```bash
sudo git clone https://github.com/p1nheiros/calculadora-logica.git
```

Windows:

```bash
git clone https://github.com/p1nheiros/calculadora-logica.git
```
